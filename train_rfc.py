...
def trainSpeakerIndependent(model_name=None):
    ...
    clf = rfc_train(train_input, train_output)
    rfc_test(clf, test_input, test_output)
...
def trainSpeakerDependent(model_name=None):
    ...
    for fold, (train_index,
        ...
        clf = rfc_train(train_input, train_output)
        result_dict, result_str = rfc_test(clf, test_input, test_output)
