...
def trainSpeakerIndependent(model_name=None):
    ...
    clf = lr_train(train_input, train_output)
    lr_test(clf, test_input, test_output)
...
def trainSpeakerDependent(model_name=None):
    ...
    for fold, (train_index,
        ...
        clf = lr_train(train_input, train_output)
        result_dict, result_str = lr_test(clf, test_input, test_output)
